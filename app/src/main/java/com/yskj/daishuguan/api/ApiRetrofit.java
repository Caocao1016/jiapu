...
import com.yskj.daishuguan.base.MyApp;
import com.yskj.daishuguan.util.MD5Utils;
import com.yskj.daishuguan.util.NetWorkUtils;
import com.yskj.daishuguan.util.SPUtil;
...
public class ApiRetrofit {
    ...
    private Interceptor mHeaderInterceptor = chain -> {
        ...
        builder.addHeader("token", RxSPTool.getContent(BaseApp.getContext(), Constant.TOKEN));
