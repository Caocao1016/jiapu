...
public final class EditTextInputHelper implements TextWatcher {
     ...
     */
    public EditTextInputHelper(TextView view, boolean alpha) {
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            if (isAlpha) {
                //设置半透明
              mView.setTextColor(Color.red(111));
            }
        }
    }
}
