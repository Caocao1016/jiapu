...
import com.yskj.daishuguan.util.GPSUtils;
...
//        postDelayed(this, 1000);
        ...
        requestRuntimePermission(new String[]{Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_FINE_LOCATION}, new PermissionListener() {
            @Override
            public void onGranted() {
                GPSUtils.getInstance(MainActivity.this).getLngAndLat(new GPSUtils.OnLocationResultListener() {
                    ...
                    public void onLocationResult(Location location) {
                         ...
                         RxSPTool.putString(MainActivity.this,Constant.GPS_LATITUDE,location.getLatitude()+"");
                        RxSPTool.putString(MainActivity.this,Constant.GPS_LONGITUDE,location.getLongitude()+"");
//                        RxSPTool.putString(MainActivity.this,Constant.GPS_ADDRESS,location.getLongitude()+"");

                    }

                    @Override
                    public void OnLocationChange(Location location) {
                        KLog.e("--OnLocationChange---",location.getLatitude());
                    }
                }) ;
            }
            @Override
            public void onDenied(List<String> deniedPermissions) {
                UIUtils.showToast("拒绝");
            }
        });
    }
