...
import com.yskj.daishuguan.adapter.UesrAdapter;
 ...
 * 2019/2/12
 *
 * @ClassName: UsedFragment
 * @Description: 已使用
 */

public class UsedFragment extends CommonLazyFragment <ManagementMoneyPresenter> implements
