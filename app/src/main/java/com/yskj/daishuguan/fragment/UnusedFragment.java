 ...
 * 2019/2/12
 *
 * @ClassName: UnusedFragment
 * @Description: 未使用
 */

public class UnusedFragment extends CommonLazyFragment<ManagementMoneyPresenter> implements
    ...
    private UnUesrAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new UnUesrAdapter(null);
