...
public class FamilyTreeView extends ViewGroup implements View.OnClickListener, View.OnLongClickListener {
    ...
    private static final float NAME_TEXT_SIZE_SP = 7f;//名称文字大小11sp
    ...
    private View createFamilyView(FamilyBean family, int left, int top) {
        ...
        RequestOptions requestOptions = new RequestOptions()
                ...
                .error(SEX_FEMALE.equals(sex) ? AVATAR_FEMALE : AVATAR_MALE).centerCrop()
                .dontAnimate();
...
//        super.onDraw(canvas);
    ...
    public void setOnFamilyLongClickListener(OnFamilyLongClickListener onFamilyLongClickListener) {
